...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/pegawai/tambahDisposisi" method="POST">
                <div class="card-header"><strong>Data</strong><small> Disposisi</small></div>
                    <div class="card-body card-block">
                        ...
                        <input type="text" name="catatan" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789',this)" maxlength="250" required></div>
                    </div>
