        ...
        <div class="col-xs-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    <strong>Masukkan Tanggal Agenda Kegiatan</strong>
                </div>
                <form action="<?php echo base_url(); ?>index.php/pegawai/printAK" method="POST" target="_BLANK">
