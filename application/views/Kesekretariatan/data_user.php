                    ...
                    <div class="col-md-12">
                        ...
                        <div id="notifications"><?php echo $this->session->flashdata('edt'); ?></div>
                            <div class="card-header">
                                <strong class="card-title"><a class="btn btn-success" href="<?php echo base_url(); ?>index.php/kesekretariatan/idxUsr">Tambah Data</a></strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    foreach($user as $hsl){ ?>
                                        ...
                                        <td><?php echo $no; ?></td><?php $no++; ?>
                                            ...
                                            <td><?php echo $hsl->level; ?></td>
                                            <td>
                                            <div class="row">
                                            <div class="col-sm-2">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/kesekretariatan/formEditUser">
                                            ...
                                            <div class="col">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/kesekretariatan/hapusUser" onclick="return confirm('Yakin Hapus ?')">
                                            <input type="hidden" name="id" value="<?php echo $hsl->id; ?>">
