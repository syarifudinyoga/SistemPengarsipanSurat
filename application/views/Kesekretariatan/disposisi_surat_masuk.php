                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <?php foreach($disposisi as $hsl){ ?>
                                        <tr>
                                            ...
                                            <div class="row">
                                            <div class="col">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/surat/formEditDisposisi">
                                            ...
                                            <div class="col">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/surat/hapusDisposisi">
                                            <input type="hidden" name="id_disposisi" value="<?php echo $hsl->id_disposisi; ?>">
                                            <input type="image" src="<?php echo base_url('assets/img/hapus.png');?>" style="width:20px";>
                                            </form>
                                            </div>
                                            <div class="col">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/surat/printDisposisi" target="_BLANK">
                                            <input type="hidden" name="id_disposisi" value="<?php echo $hsl->id_disposisi; ?>">
                                            <input type="image" src="<?php echo base_url('assets/img/print.png');?>" style="width:20px";>
                                            </form>
                                            </div>
                                            </div>
                                            </td>
