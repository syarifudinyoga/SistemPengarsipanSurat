...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/pegawai/editAgenda" method="POST">
                <div class="card-header"><strong>Data</strong><small> Agenda</small></div>
                    <div class="card-body card-block">
                        ...
                        <input type="text" name="nama_kegiatan" class="form-control" value="<?php echo $agenda[0]->nama_kegiatan; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789,.',this)" maxlength="25" required></div>
                        <div class="form-group"><label class=" form-control-label">Tanggal Pelaksanaan</label>
                        <input type="date" name="tanggal_pelaksanaan" class="form-control" value="<?php echo $agenda[0]->tanggal_pelaksanaan; ?>" required></div>
                        <div class="form-group"><label class=" form-control-label">Waktu Pelaksanaan</label>
                        <input type="time" name="waktu_pelaksanaan" class="form-control" value="<?php echo $agenda[0]->waktu_pelaksanaan; ?>" required></div>
                        <div class="form-group"><label class=" form-control-label">Tempat</label>
                        <input type="text" name="tempat" class="form-control" value="<?php echo $agenda[0]->tempat; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789',this)" maxlength="50" required></div>
