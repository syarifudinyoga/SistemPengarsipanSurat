...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/surat/editDisposisi" method="POST">
                <div class="card-header"><strong>Data</strong><small> Disposisi</small></div>
                    <div class="card-body card-block">
                        ...
                        <input type="text" name="asal_surat" class="form-control" value="<?php echo $disposisi[0]->asal_surat; ?>" maxlength="20" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789/',this)" required></div>
                        <div class="form-group"><label class=" form-control-label">No. Surat</label>
                        <input type="text" name="no_surat" class="form-control" value="<?php echo $disposisi[0]->no_surat; ?>" maxlength="50" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789./',this)" required></div>
                        <div class="form-group"><label class=" form-control-label">Tanggal Surat</label>
                        <input type="date" name="tgl_surat" class="form-control" value="<?php echo $disposisi[0]->tgl_surat; ?>" required></div>
                        <div class="form-group"><label class=" form-control-label">Tanggal Terima</label>
                        <input type="date" name="tgl_terima" class="form-control" value="<?php echo $disposisi[0]->tgl_terima; ?>" required></div>
                        <div class="form-group"><label class=" form-control-label">No Surat Masuk</label>
                        <div class="form-group">
                            <select name="id_surat_masuk" class="form-control" required>
        	                    <option value="">-- Pilih No Surat Masuk --</option>
                                    <?php
                                foreach ($suma as $sm) {
                                echo "<option value='".$sm->id_surat_masuk."'>".$sm->id_surat_masuk."</option>";
                                }
                                echo"
                            </select>"
                                ?>
                        ...
                        <input type="text" name="sifat_surat" class="form-control" value="<?php echo $disposisi[0]->sifat_surat; ?>" maxlength="20" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ ',this)" required></div>
                        <div class="form-group"><label class=" form-control-label">Perihal</label>
                        <input type="text" name="perihal" class="form-control" value="<?php echo $disposisi[0]->perihal; ?>" maxlength="250" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789/',this)" required></div>
                        ...
                        <input type="text" name="catatan" class="form-control" value="<?php echo $disposisi[0]->catatan; ?>" maxlength="250" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789-/.',this)" required></div>
                    </div>
