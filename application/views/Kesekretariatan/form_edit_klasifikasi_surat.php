...
<body>
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Form Edit Klasifikasi Surat</h1>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/surat/editKlasifikasiSurat" method="POST" enctype="multipart/form-data">
                <div class="card-header"><strong>Data</strong><small> Klasifikasi Surat</small></div>
                    <div class="card-body card-block">
                        <div class="form-group"><label class=" form-control-label">Kode Surat</label>
                        <input type="hidden" name="kode_surat" class="form-control" value="<?php echo $klas[0]->kode_surat; ?>" onKeyPress="return goodchars(event,'0123456789.',this)" maxlength="10" required>
                        <input type="text" name="kode_surat" class="form-control" value="<?php echo $klas[0]->kode_surat; ?>" disabled></div>
                        <div class="form-group"><label class=" form-control-label">Perihal Surat</label>
                        <input type="text" name="perihal_surat" class="form-control" value="<?php echo $klas[0]->perihal_surat; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789,/',this)" maxlength="50" required></div>
                    </div>
