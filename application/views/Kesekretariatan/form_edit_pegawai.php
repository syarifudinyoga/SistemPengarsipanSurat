...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/kesekretariatan/editPegawai" method="POST">
                <div class="card-header"><strong>Data</strong><small> Pegawai</small></div>
                    <div class="card-body card-block">
                        ...
                        <input type="hidden" name="bagian" class="form-control" value="<?php echo $pegawai[0]->bagian; ?>">
                        <input type="text" name="bagian" class="form-control" value="<?php echo $pegawai[0]->bagian; ?>" disabled></div>
                        <div class="form-group"><label class=" form-control-label">NIP</label>
                        <input type="text" name="nip" class="form-control" value="<?php echo $pegawai[0]->nip; ?>" onKeyPress="return goodchars(event,'0123456789',this)" maxlength="50" required></div>
                        <div class="form-group"><label class=" form-control-label">Nama</label>
                        <input type="text" name="nama" class="form-control" value="<?php echo $pegawai[0]->nama; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ ',this)"  maxlength="50" required></div>
                    </div>
