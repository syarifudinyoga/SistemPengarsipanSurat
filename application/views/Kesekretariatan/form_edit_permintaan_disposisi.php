...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/surat/editPermintaanDisposisi" method="POST">
                <div class="card-header"><strong>Data</strong><small> Disposisi</small></div>
                    <div class="card-body card-block">
                        ...
                        <input type="text" name="asal_surat" class="form-control" value="<?php echo $disposisi[0]->asal_surat; ?>" required onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789',this)" maxlength="50"></div>

                        <div class="form-group"><label class=" form-control-label">No. Surat</label>
                        <input type="text" name="no_surat" class="form-control" value="<?php echo $disposisi[0]->no_surat; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789./',this)" maxlength="50" required></div>
                        ...
                        <input type="text" name="sifat_surat" class="form-control" value="<?php echo $disposisi[0]->sifat_surat; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ ',this)" maxlength="20" required></div>

                        <div class="form-group"><label class=" form-control-label">Perihal</label>
                        <input type="text" name="perihal" class="form-control" value="<?php echo $disposisi[0]->perihal; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ ',this)" maxlength="250" required></div>
