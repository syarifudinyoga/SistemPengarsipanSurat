...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/surat/editSuratKeluar" method="POST" enctype="multipart/form-data">
                <div class="card-header"><strong>Data</strong><small> Surat Masuk</small></div>
                    <div class="card-body card-block">
                        ...
                        <input type="hidden" name="id_surat_keluar" class="form-control" value="<?php echo $suratkeluar[0]->id_surat_keluar; ?>">
                        <input type="text" name="id_surat_keluar" class="form-control" value="<?php echo $suratkeluar[0]->id_surat_keluar; ?>" disabled></div>
                        <div class="form-group"><label class=" form-control-label">No Naskah</label>
                        <input type="text" name="no_naskah_dinas" class="form-control" value="<?php echo $suratkeluar[0]->no_naskah_dinas; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789./',this)" maxlength="25" required></div>
                        ...
                        <input type="date" name="tgl_surat" class="form-control" value="<?php echo $suratkeluar[0]->tgl_surat; ?>"></div>
                        <div class="form-group"><label class=" form-control-label">Uraian</label>
                        <input type="text" name="uraian" class="form-control" value="<?php echo $suratkeluar[0]->uraian; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789./',this)" maxlength="250" required></div>
                        <div class="form-group"><label class=" form-control-label">Tanggal keluar</label>
                        <input type="date" name="tgl_keluar" class="form-control" value="<?php echo $suratkeluar[0]->tgl_keluar; ?>" required></div>
                        ...
                        <input type="text" name="ket" class="form-control" value="<?php echo $suratkeluar[0]->ket; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ',this)" maxlength="20" required></div>
                        <div class="form-group"><label class=" form-control-label">File</label>
                        <input type="file" name="fileSk" class="form-control" required></div>
                    </div>
