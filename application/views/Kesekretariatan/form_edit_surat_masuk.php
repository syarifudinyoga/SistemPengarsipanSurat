...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/surat/editSuratMasuk" method="POST" enctype="multipart/form-data">
                <div class="card-header"><strong>Data</strong><small> Surat Masuk</small></div>
                    <div class="card-body card-block">
                        <div class="form-group"><label class=" form-control-label">ID</label>
                        <input type="hidden" name="id_surat_masuk" class="form-control" value="<?php echo $suratmasuk[0]->id_surat_masuk; ?>">
                        <input type="text" name="id_surat_masuk" class="form-control" value="<?php echo $suratmasuk[0]->id_surat_masuk; ?>" disabled></div>
                        <div class="form-group"><label class=" form-control-label">No Naskah</label>
                        <input type="text" name="no_naskah" class="form-control" value="<?php echo $suratmasuk[0]->no_naskah; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789./',this)" maxlength="20" required></div>
                        <div class="form-group"><label class=" form-control-label">Klasifikasi Surat</label>
                        <div class="form-group">
                            <select name="kode_surat" class="form-control" required>
        	                    <option value="">-- Pilih Klasifikasi --</option>
                                    <?php
                                foreach ($klas as $klas) {
                                echo "<option value='".$klas->kode_surat."'>".$klas->kode_surat.". ".$klas->perihal_surat."</option>";
                                }
                                echo"
                            </select>"
                                ?>
                        </div>
                        <div class="form-group"><label class=" form-control-label">Tanggal Penerimaan</label>
                        <input type="date" name="tgl_penerimaan" class="form-control" value="<?php echo $suratmasuk[0]->tgl_penerimaan; ?>" required></div>
                        <div class="form-group"><label class=" form-control-label">Uraian</label>
                        <input type="text" name="uraian" class="form-control" value="<?php echo $suratmasuk[0]->uraian; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789./',this)" maxlength="250" required></div>
                        <div class="form-group"><label class=" form-control-label">Tanggal Penyampaian</label>
                        <input type="date" name="tgl_penyampaian" class="form-control" value="<?php echo $suratmasuk[0]->tgl_penyampaian; ?>" required></div>
                        <div class="form-group"><label class=" form-control-label">Bagian</label>
                        <div class="form-group">
                            <select name="bagian" class="form-control" required>
        	                    <option value="" diselected disabled>-- Pilih Bidang --</option>
                                    <?php
                        ...
                        <div class="form-group"><label class=" form-control-label">Ket</label>
                        <input type="text" name="ket" class="form-control" value="<?php echo $suratmasuk[0]->ket; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789./',this)" maxlength="50" required></div>
                        <div class="form-group"><label class=" form-control-label">File</label>
                        <input type="file" name="fileSm" class="form-control" required></div>
                    </div>
