...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/kesekretariatan/editUser" method="POST">
                <div class="card-header"><strong>Data</strong><small> User</small></div>
                    <div class="card-body card-block">
                        <div class="form-group"><label class=" form-control-label">Id</label>
                        <input type="hidden" name="id" class="form-control" value="<?php echo $user[0]->id; ?>">
                        <input type="text" name="id" class="form-control" value="<?php echo $user[0]->id; ?>" disabled></div>
                        <div class="form-group"><label class=" form-control-label">Nama</label>
                        <input type="text" name="nama" class="form-control" value="<?php echo $user[0]->nama; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ',this)" maxlength="50" required></div>
                        <div class="form-group"><label class=" form-control-label">Email</label>
                        <input type="email" name="email" class="form-control" value="<?php echo $user[0]->email; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789./@',this)" maxlength="50" required></div>
                        <div class="form-group"><label class=" form-control-label">Password</label>
                        <input type="password" name="password" class="form-control" value="<?php echo $user[0]->password; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789',this)" maxlength="50" required></div>
                        <div class="form-group"><label class=" form-control-label">Level</label>
                        <input type="hidden" name="level" class="form-control" value="<?php echo $user[0]->level; ?>">
                        <input type="text" name="level" class="form-control" value="<?php echo $user[0]->level; ?>" disabled></div>
                    </div>
