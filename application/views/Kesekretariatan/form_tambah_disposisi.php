...
<body>
    ...
    <div id="right-panel" class="right-panel">
            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Tambah Disposisi Surat Masuk</h1>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/surat/tambahDisposisi" method="POST">
                <div class="card-header"><strong>Data</strong><small> Surat Disposisi</small></div>
                    <div class="card-body card-block">
                        <div class="form-group"><label for="company" class=" form-control-label">Id Disposisi</label>
                        <input type="text" name="id_disposisi" placeholder="ID" class="form-control" disabled></div>
                        <div class="form-group"><label for="vat" class=" form-control-label">Asal Surat</label>
                        <input type="text" name="asal_surat" placeholder="Masukkan Asal Surat" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789',this)" maxlength="20" required></div>
                        <div class="form-group"><label for="street" class=" form-control-label">No. Surat</label>
                        <input type="text" name="no_surat" placeholder="Masukkan No. Surat" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789./',this)" maxlength="50" required></div>
                        <div class="form-group"><label for="company" class=" form-control-label">Tanggal Surat</label>
                        <input type="date" name="tgl_surat" placeholder="Masukan Tanggal Surat" class="form-control" required></div>
                        <div class="form-group"><label for="vat" class=" form-control-label">Tanggal Terima</label>
                        <input type="date" name="tgl_terima" placeholder="Masukkan Tanggal Terima" class="form-control" required></div>
                        ...
                        <div class="form-group"><label for="company" class=" form-control-label">Sifat Surat</label>
                        <input type="text" name="sifat_surat" placeholder="Masukan Sifat Surat" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ',this)" maxlength="20" required></div>
                        <div class="form-group"><label for="vat" class=" form-control-label">Perihal</label>
                        <input type="text" name="perihal" placeholder="Masukkan Perihal" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789',this)" maxlength="250" required></div>
                        ...
                        <div class="form-group"><label for="company" class=" form-control-label">Catatan</label>
                        <input type="text" name="catatan" placeholder="Masukan Catatan" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789',this)" maxlength="250" required></div>
                    </div>
