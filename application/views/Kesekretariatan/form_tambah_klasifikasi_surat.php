...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/surat/tambahKlasifikasiSurat" method="POST">
                <div class="card-header"><strong>Data</strong><small> Klasifikasi Surat</small></div>
                    <div class="card-body card-block">
                        <div class="form-group"><label for="company" class=" form-control-label">Kode Surat</label>
                        <input type="text" name="kode_surat" placeholder="Masukkan Kode Surat" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789./',this)" maxlength="10" required></div>
                        <div class="form-group"><label for="vat" class=" form-control-label">Perihal Surat</label>
                        <input type="text" name="perihal_surat" placeholder="Masukkan Perihal Surat" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789',this)" maxlength="50" required></div>
                    </div>
