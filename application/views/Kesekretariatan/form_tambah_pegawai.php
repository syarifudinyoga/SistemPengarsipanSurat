...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/kesekretariatan/tambahPegawai" method="POST">
                <div class="card-header"><strong>Data</strong><small> Pegawai</small></div>
                    <div class="card-body card-block">
                        <div class="form-group"><label for="company" class=" form-control-label">Bagian</label>
                        <input type="text" name="bagian" placeholder="Masukkan Bagian" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ ',this)" maxlength="50" required></div>
                        <div class="form-group"><label for="vat" class=" form-control-label">NIP</label>
                        <input type="text" name="nip" placeholder="Masukkan NIP" class="form-control" onKeyPress="return goodchars(event,'0123456789',this)" maxlength="50" required></div>
                        <div class="form-group"><label for="street" class=" form-control-label">Nama</label>
