...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/surat/tambahPermintaanDisposisi" method="POST">
                <div class="card-header"><strong>Data</strong><small> Permohonan Disposisi</small></div>
                    <div class="card-body card-block">
                        ...
                        <input type="text" name="asal_surat" placeholder="Masukkan Asal Surat" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ ',this)" maxlength="50" required></div>
