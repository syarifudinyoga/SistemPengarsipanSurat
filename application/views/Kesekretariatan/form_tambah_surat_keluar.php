...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/surat/tambahSuratKeluar" method="POST" enctype="multipart/form-data">
                <div class="card-header"><strong>Data</strong><small> Surat Keluar</small></div>
                    <div class="card-body card-block">
                        <div class="form-group"><label class=" form-control-label">Id</label>
                        <input type="text" name="id_surat_keluar" placeholder="ID" class="form-control" disabled></div>
                        <div class="form-group"><label class=" form-control-label">No Naskah</label>
                        <input type="text" name="no_naskah_dinas" placeholder="Masukkan No Naskah" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789./',this)" maxlength="25" required></div>
                        ...
                        <input type="date" name="tgl_surat" placeholder="Masukkan Tanggal Penerimaan" class="form-control" required></div>
                        <div class="form-group"><label class=" form-control-label">Uraian</label>
                        <input type="text" name="uraian" placeholder="Masukkan Uraian" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789.',this)" maxlength="250" required></div>
                        <div class="form-group"><label class=" form-control-label">Tanggal Keluar</label>
                        <input type="date" name="tgl_keluar" placeholder="Masukkan Tanggal Penyampaian" class="form-control" required></div>
                        ...
                        <input type="text" name="ket" placeholder="Masukkan Keterangan" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789./',this)" maxlength="20" required></div>
