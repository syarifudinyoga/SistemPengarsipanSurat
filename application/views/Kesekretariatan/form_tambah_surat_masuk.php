...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/surat/tambahSuratMasuk" method="POST" enctype="multipart/form-data">
                <div class="card-header"><strong>Data</strong><small> Surat Masuk</small></div>
                    <div class="card-body card-block">
                        ...
                        <input type="text" name="id_surat_masuk" placeholder="ID" class="form-control" disabled></div>
                        <div class="form-group"><label class=" form-control-label">No Naskah</label>
                        <input type="text" name="no_naskah" placeholder="Masukkan No Naskah" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789./',this)" maxlength="20" required></div>
                        ...
                        <input type="date" name="tgl_penerimaan" placeholder="Masukkan Tanggal Penerimaan" class="form-control" required></div>
                        <div class="form-group"><label class=" form-control-label">Uraian</label>
                        <input type="text" name="uraian" placeholder="Masukkan Uraian" class="form-control" maxlength="250" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789',this)" required></div>
                        <div class="form-group"><label class=" form-control-label">Tanggal Penyampaian</label>
                        <input type="date" name="tgl_penyampaian" placeholder="Masukkan Tanggal Penyampaian" class="form-control" required></div>
                        ...
                        <input type="text" name="ket" placeholder="Masukkan Keterangan" class="form-control" maxlength="50" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789.',this)" required></div>
                        <div class="form-group"><label class=" form-control-label">File Surat</label>
