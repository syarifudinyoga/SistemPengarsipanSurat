                    ...
                    <div class="col-md-12">
                        ...
                        <div id="notifications"><?php echo $this->session->flashdata('edt'); ?></div>
                            <div class="card-header">
                                <strong class="card-title"><a class="btn btn-success" href="<?php echo base_url(); ?>index.php/surat/idxKS">Tambah Data</a></strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    foreach($klas as $hsl){ ?>
                                        <tr>
                                            ...
                                            <td><?php echo $hsl->kode_surat; ?></td>
                                            <td><?php echo $hsl->perihal_surat; ?></td>
                                            <td>
                                            <div class="row">
                                            <div class="col-sm-2">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/surat/formEditKlasifikasiSurat">
                                                <input type="hidden" name="kode_surat" value="<?php echo $hsl->kode_surat; ?>">
                                                <input type="image" src="<?php echo base_url('assets/img/edit.png');?>" style="width:18px";>
                                            </form>
                                            </div>
                                            <div class="col-sm-2">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/surat/hapusKlasifikasiSurat" onclick="return confirm('Yakin Hapus ?')" >
                                            <input type="hidden" id="hapus" name="kode_surat" value="<?php echo $hsl->kode_surat; ?>">
                                            <input type="image" id="hapus" src="<?php echo base_url('assets/img/hapus.png');?>" style="width:18px"; onclick="hapus(<?php echo $hsl->kode_surat ?>)">
                                            </form>
                                            </div>
                                            </div>
                                            </td>
