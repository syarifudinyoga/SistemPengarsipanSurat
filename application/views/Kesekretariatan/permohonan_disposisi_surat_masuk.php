                    ...
                    <div class="col-md-12">
                        ...
                        <div id="notifications"><?php echo $this->session->flashdata('edt'); ?></div>
                            <div class="card-header">
                                <strong class="card-title"><a class="btn btn-success" href="<?php echo base_url(); ?>index.php/surat/idxPermintaanDisposisi">Tambah Data</a></strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <?php foreach($disposisi as $hsl){ ?>
                                        <tr>
                                            <td><?php echo $hsl->id_disposisi; ?></td>
                                            ...
                                            <div class="row">
                                            <div class="col">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/surat/formEditPermintaanDisposisi">
                                            ...
                                            <div class="col">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/surat/hapusPermintaanDisposisi" onclick="return confirm('Yakin Hapus ?')">
                                            <input type="hidden" name="id_disposisi" value="<?php echo $hsl->id_disposisi; ?>">
