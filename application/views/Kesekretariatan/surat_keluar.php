                    ...
                    <div class="col-md-12">
                        ...
                        <div id="notifications"><?php echo $this->session->flashdata('edt'); ?></div>
                            <div class="card-header">
                                <strong class="card-title"><a class="btn btn-success" href="<?php echo base_url(); ?>index.php/surat/idxSK">Tambah Data</a></strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th width="300px">Uraian/Perihal</th>
                                    ...
                                    <?php
                                    $no=1;
                                    foreach($suratkeluar as $hsl){ ?>
                                        <tr>
                                            <td><?php echo $no; ?></td><?php $no++; ?>
                                            <td><?php echo $hsl->no_naskah_dinas; ?></td>
                                            <td><?php echo $hsl->perihal_surat; ?></td>
                                            <td><?php echo $hsl->tgl_surat; ?></td>
                                            <td><?php echo $hsl->uraian; ?></td>
                                            <td><?php echo $hsl->tgl_keluar; ?></td>
                                            <td><?php echo $hsl->bagian; ?></td>
                                            <td><?php echo $hsl->ket; ?></td>
                                            <td><?php echo $hsl->fileSk; ?></td>
                                            <td>
                                            <div class="row">
                                            <div class="col-sm-2">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/surat/formEditSuratKeluar">
                                                <input type="hidden" name="id_surat_keluar" value="<?php echo $hsl->id_surat_keluar; ?>">
                                                <input type="image" src="<?php echo base_url('assets/img/edit.png');?>" style="width:18px";>
                                            </form>
                                            </div>
                                            <div class="col-sm-2">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/surat/hapusSuratKeluar" onclick="return confirm('Yakin Hapus ?')">
                                                <input type="hidden" name="id_surat_keluar" value="<?php echo $hsl->id_surat_keluar; ?>">
                                            <input type="image" src="<?php echo base_url('assets/img/hapus.png');?>" style="width:18px";>
                                            </form>
                                            </div>
                                            <div class="col">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/surat/printPdfSk" target="blank">
                                                <input type="hidden" name="id_surat_keluar" value="<?php echo $hsl->id_surat_keluar; ?>">
