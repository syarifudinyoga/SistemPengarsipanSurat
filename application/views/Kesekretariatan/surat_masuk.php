...
<body>
                    ...
                    <div class="col-md-12">
                        ...
                        <div id="notifications"><?php echo $this->session->flashdata('edt'); ?></div>
                            <div class="card-header">
                                <strong class="card-title"><a class="btn btn-success" href="<?php echo base_url(); ?>index.php/surat/idxSM">Tambah Data</a></strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th width="20px">No</th>
                                            <th width="70px">Nomor Naskah Dinas</th>
                                            <th width="20px">Klasifikasi Surat</th>
                                            <th width="80px">Tanggal Penerimaan</th>
                                            <th width="400px">Uraian/Perihal</th>
                                    ...
                                    <?php
                                    $no=1;
                                    foreach($suratmasuk as $hsl){ ?>
                                        <tr>
                                            <td><?php echo $no; ?></td><?php $no++; ?>
                                            <td><?php echo $hsl->no_naskah; ?></td>
                                            <td><?php echo $hsl->perihal_surat; ?></td>
                                            ...
                                            <td><?php echo $hsl->fileSm; ?></td>
                                            <td>
                                            <div class="row">
                                            <div class="col-sm-2">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/surat/formEditSuratMasuk">
                                                <input type="hidden" name="id_surat_masuk" value="<?php echo $hsl->id_surat_masuk; ?>">
                                                <input type="image" src="<?php echo base_url('assets/img/edit.png');?>" style="width:18px";>
                                            </form>
                                            </div>
                                            <div class="col-sm-2">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/surat/hapusSuratMasuk" onclick="return confirm('Yakin Hapus ?')" >
                                            <input type="hidden" id="hapus" name="id_surat_masuk" value="<?php echo $hsl->id_surat_masuk; ?>">
                                            <input type="image" id="hapus" src="<?php echo base_url('assets/img/hapus.png');?>" style="width:18px"; onclick="hapus(<?php echo $hsl->id_surat_masuk ?>)">
                                            </form>
                                            </div>
                                            <div class="col">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/surat/printPdfSm" target="blank">
                                                <input type="hidden" name="id_surat_masuk" value="<?php echo $hsl->id_surat_masuk; ?>">
                                                <input type="image" src="<?php echo base_url('assets/img/pdf.png');?>" style="width:18px";>
                                            </form>
                                            </div>
                                            </div>
                                            </td>
    ...
    <script>
        $('#notifications').slideDown('slow').delay(5).slideUp('slow');
    </script>
