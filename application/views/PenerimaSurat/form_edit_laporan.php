...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/pegawai/editLaporan" method="POST">
                <div class="card-header"><strong>Data</strong><small> Laporan Kegiatan</small></div>
                    <div class="card-body card-block">
                        <div class="form-group"><label class=" form-control-label">ID Kegiatan</label>
                        <input type="hidden" name="id_kegiatan" class="form-control" value="<?php echo $laporan[0]->id_kegiatan; ?>">
                        <input type="text" name="id_kegiatan" class="form-control" value="<?php echo $laporan[0]->id_kegiatan; ?>" disabled></div>
                        <div class="form-group"><label class=" form-control-label">Nama Kegiatan</label>
                        <input type="text" name="nama_kegiatan" class="form-control" value="<?php echo $laporan[0]->nama_kegiatan; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789',this)" maxlength="50" required></div>
                        <div class="form-group"><label class=" form-control-label">Tanggal Kegiatan</label>
                        <input type="date" name="tgl_kegiatan" class="form-control" value="<?php echo $laporan[0]->tgl_kegiatan; ?>" required></div>
                        ...
                        <div class="form-group"><label class=" form-control-label">Hasil</label>
                        <input type="text" name="hasil" class="form-control" value="<?php echo $laporan[0]->hasil; ?>" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789',this)" maxlength="200" required></div>
