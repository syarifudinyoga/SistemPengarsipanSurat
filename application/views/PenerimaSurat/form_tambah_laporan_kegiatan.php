...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="col-lg-12">
            <div class="card">
            <form action="<?php echo base_url(); ?>index.php/pegawai/tambahLaporan" method="POST">
                <div class="card-header"><strong>Data</strong><small> Kegiatan</small></div>
                    <div class="card-body card-block">
                        <div class="form-group"><label for="company" class=" form-control-label">Id Kegiatan</label>
                        <input type="text" name="id_kegiatan" placeholder="ID" class="form-control" disabled></div>
                        <div class="form-group"><label for="vat" class=" form-control-label">Nama Kegiatan</label>
                        <input type="text" name="nama_kegiatan" placeholder="Masukkan Nama Kegiatan" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789',this)" maxlength="50" required></div>
                        <div class="form-group"><label for="street" class=" form-control-label">Tanggal Kegiatan</label>
                        <input type="date" name="tgl_kegiatan" placeholder="Masukkan Tanggal Kegiatan" class="form-control" required></div>
                        ...
                        <div class="form-group"><label for="company" class=" form-control-label">Hasil</label>
                        <input type="text" name="hasil" placeholder="Masukan Hasil" class="form-control" onKeyPress="return goodchars(event,'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ 0123456789',this)" maxlength="200" required></div>
                    </div>
