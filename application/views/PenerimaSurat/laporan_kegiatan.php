            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-12">
                        ...
                        <div class="card-header">
                                <strong class="card-title"><a class="btn btn-success" href="<?php echo base_url(); ?>index.php/pegawai/idxLK">Tambah Data</a></strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <?php
                                    $no=1;
                                    foreach($laporan as $hsl){ ?>
                                        <tr>
                                            <td><?php echo $no; ?></td><?php $no++; ?>
                                            <td><?php echo $hsl->nama_kegiatan; ?></td>
                                            <td><?php echo $hsl->tgl_kegiatan; ?></td>
                                            <td><?php echo $hsl->bagian; ?></td>
                                            <td><?php echo $hsl->hasil; ?></td>
                                            <td>
                                            <div class="row">
                                            <div class="col-sm-2">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/pegawai/formEditLaporan">
                                                <input type="hidden" name="id_kegiatan" value="<?php echo $hsl->id_kegiatan; ?>">
                                                <input type="image" src="<?php echo base_url('assets/img/edit.png');?>" style="width:18px";>
                                            </form>
                                            </div>
                                            <div class="col">
                                            <form method="POST" action="<?php echo base_url(); ?>index.php/pegawai/hapusLaporan" onclick="return confirm('Yakin Hapus ?')">
                                                <input type="hidden" name="id_kegiatan" value="<?php echo $hsl->id_kegiatan; ?>">
